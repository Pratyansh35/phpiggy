    ...
    >
        ...
        <label class="block">
            ...
            >
                ...
                <option value="Mexico">Russia</option>
        ...
        <label class="block">
            ...
            <?php if (array_key_exists('confirm', $errors)) : ?>
                <div class="bg-gray-100 mt-2 p-2 text-red-500"><?= e($errors['confirm'][0]); ?></div>
            <?php endif; ?>
        </label>
        <!-- Terms of Service -->
        <div class="block">
            <div class="mt-2">
                <div>
                    ...
                    <?php if (array_key_exists('accept', $errors)) : ?>
                        <div class="bg-gray-100 mt-2 p-2 text-red-500"><?= e($errors['accept'][0]); ?></div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
